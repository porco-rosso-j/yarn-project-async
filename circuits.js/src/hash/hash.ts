 ...
 */
export async function computeNoteContentHash(noteContent: Fr[]): Promise<Fr> {
 ...
 */
export async function computeInnerNoteHash(storageSlot: Fr, noteHash: Fr): Promise<Fr> {
 ...
 */
export async function computeUniqueNoteHash(nonce: Fr, innerNoteHash: Fr): Promise<Fr> {
...
export async function computeL1ToL2MessageNullifier(
