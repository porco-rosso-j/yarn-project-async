...
export class ParentContract extends ContractBase {
   ...
   */
  public static deployWithOpts<M extends keyof ParentContract['methods']>(
    opts: { publicKeysHash?: Fr; method?: M; wallet: Wallet },
    ...args: Parameters<ParentContract['methods'][M]>
  ) {
    return new DeployMethod<ParentContract>(
  ...
  public override methods!: {
    ...
    enqueue_calls_to_child_with_nested_last: ((
      target_contract: AztecAddressLike,
      target_selector: FunctionSelectorLike,
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    enqueue_calls_to_child_with_nested_first: ((
      target_contract: AztecAddressLike,
      target_selector: FunctionSelectorLike,
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
