...
export class TestContract extends ContractBase {
  ...
  public override methods!: {
    ...
    assert_public_global_vars: ((
      ...
      fee_per_da_gas: FieldLike,
      fee_per_l2_gas: FieldLike,
    ) => ContractFunctionInteraction) &
    ...
    test_shared_mutable_private_getter_for_registry_contract: ((
      storage_slot_of_shared_mutable: FieldLike,
      address_to_get_in_registry: AztecAddressLike,
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    compute_outgoing_log_body_ciphertext: ((
      eph_sk: { lo: FieldLike; hi: FieldLike },
      recipient: AztecAddressLike,
      recipient_ivpk_app: { x: FieldLike; y: FieldLike; is_infinite: boolean },
      ovsk_app: { lo: FieldLike; hi: FieldLike },
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    test_nullifier_key_freshness: ((
      ...
      public_nullifying_key: { x: FieldLike; y: FieldLike; is_infinite: boolean },
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;

    /** compute_note_header_ciphertext(secret: struct, point: struct) */
    compute_note_header_ciphertext: ((
    ...
    get_master_incoming_viewing_public_key: ((address: AztecAddressLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    create_l2_to_l1_message_public: ((
      amount: FieldLike,
    ...
    set_tx_max_block_number: ((
      max_block_number: bigint | number,
      enqueue_public_call: boolean,
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
    ...
    test_shared_mutable_private_getter: ((
      contract_address_to_read: AztecAddressLike,
      storage_slot_of_shared_mutable: FieldLike,
    ) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
