...
export const PrivateTokenContractArtifact = loadContractArtifact(
  PrivateTokenContractArtifactJson as NoirCompiledContract,
);
...
export class PrivateTokenContract extends ContractBase {
  ...
  public override methods!: {
    ...
    balance_of_unconstrained: ((owner_npk_m_hash: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;

    /** assert_minter_and_mint(minter: struct, amount: field) */
    assert_minter_and_mint: ((minter: AztecAddressLike, amount: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, 'selector'>;
