...
export declare class SchnorrAccountContract extends ContractBase {
     ...
     */
    static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, signing_pub_key_x: FieldLike, signing_pub_key_y: FieldLike): DeployMethod<SchnorrAccountContract>;
    /**
