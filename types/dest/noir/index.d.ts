import { type ABIParameter, type ABIParameterVisibility, type AbiType, type AbiValue, type DebugFileMap, type DebugInfo } from '@aztec/foundation/abi';
...
export declare const AZTEC_VIEW_ATTRIBUTE = "aztec(view)";
/**
