...
export class AccountWallet extends BaseWallet {
   ...
   */
  private async getMessageHash(intent: IntentInnerHash | IntentAction): Promise<Fr> {
  ...
  public async rotateNullifierKeys(newNskM: Fq = Fq.random()): Promise<void> {
    ...
    const interaction = new ContractFunctionInteraction(
      ...
      [this.getAddress(), (await derivePublicKeyFromSecretKey(newNskM)).toNoirStruct(), Fr.ZERO],
    );
