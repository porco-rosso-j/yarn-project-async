...
export class EncryptedLogOutgoingBody {
   ...
   */
  public async computeCiphertext(ovskApp: GrumpkinScalar, ephPk: PublicKey) {
   ...
   */
  public static async fromCiphertext(
    ciphertext: Buffer | bigint[],
    ovskApp: GrumpkinScalar,
    ephPk: PublicKey,
  ): Promise<EncryptedLogOutgoingBody> {
   ...
   */
  private static async derivePoseidonAESSecret(ovskApp: GrumpkinScalar, ephPk: PublicKey) {
