...
export type CircuitName = 'base-parity' | 'root-parity' | 'base-rollup' | 'merge-rollup' | 'root-rollup' | 'private-kernel-init' | 'private-kernel-inner' | 'private-kernel-reset-full' | 'private-kernel-reset-big' | 'private-kernel-reset-medium' | 'private-kernel-reset-small' | 'private-kernel-tail' | 'private-kernel-tail-to-public' | 'app-circuit' | 'public-kernel-setup' | 'public-kernel-app-logic' | 'public-kernel-teardown' | 'public-kernel-tail' | 'avm-circuit' | 'empty-nested' | 'private-kernel-empty';
...
export type Stats = AvmSimulationStats | CircuitProvingStats | CircuitSimulationStats | CircuitWitnessGenerationStats | PublicDBAccessStats | L1PublishStats | L2BlockBuiltStats | L2BlockHandledStats | NodeSyncedChainHistoryStats | NoteProcessorCaughtUpStats | ProofConstructed | TreeInsertionStats | TxAddedToPoolStats;
