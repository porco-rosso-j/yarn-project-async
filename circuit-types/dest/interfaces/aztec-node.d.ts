import { type ARCHIVE_HEIGHT, type Header, type L1_TO_L2_MSG_TREE_HEIGHT, type NOTE_HASH_TREE_HEIGHT, type NULLIFIER_TREE_HEIGHT, type PUBLIC_DATA_TREE_HEIGHT } from '@aztec/circuits.js';
import { type L1ContractAddresses } from '@aztec/ethereum';
import { type ContractArtifact } from '@aztec/foundation/abi';
import { type AztecAddress } from '@aztec/foundation/aztec-address';
import { type Fr } from '@aztec/foundation/fields';
import { type ContractClassPublic, type ContractInstanceWithAddress, type ProtocolContractAddresses } from '@aztec/types/contracts';
import { type L2Block } from '../l2_block.js';
import { type FromLogType, type GetUnencryptedLogsResponse, type L2BlockL2Logs, type LogFilter, type LogType } from '../logs/index.js';
...
export interface AztecNode {
     ...
     */
    getL1ToL2MessageMembershipWitness(blockNumber: L2BlockNumber, l1ToL2Message: Fr, startIndex: bigint): Promise<[bigint, SiblingPath<typeof L1_TO_L2_MSG_TREE_HEIGHT>] | undefined>;
    /**
