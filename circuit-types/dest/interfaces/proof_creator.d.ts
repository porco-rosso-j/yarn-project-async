import { type NESTED_RECURSIVE_PROOF_LENGTH, type PrivateCircuitPublicInputs, type PrivateKernelCircuitPublicInputs, type PrivateKernelInitCircuitPrivateInputs, type PrivateKernelInnerCircuitPrivateInputs, type PrivateKernelResetCircuitPrivateInputsVariants, type PrivateKernelTailCircuitPrivateInputs, type PrivateKernelTailCircuitPublicInputs, type RECURSIVE_PROOF_LENGTH, type RecursiveProof, type VerificationKeyAsFields } from '@aztec/circuits.js';
...
export interface ProofCreator {
     ...
     */
    createProofInit(privateKernelInputsInit: PrivateKernelInitCircuitPrivateInputs): Promise<KernelProofOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    createProofInner(privateKernelInputsInner: PrivateKernelInnerCircuitPrivateInputs): Promise<KernelProofOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    createProofReset(privateKernelInputsReset: PrivateKernelResetCircuitPrivateInputsVariants): Promise<KernelProofOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    createProofTail(privateKernelInputsTail: PrivateKernelTailCircuitPrivateInputs): Promise<KernelProofOutput<PrivateKernelTailCircuitPublicInputs>>;
    /**
     ...
     */
    createAppCircuitProof(partialWitness: any, bytecode: Buffer, appCircuitName?: string): Promise<AppCircuitProofOutput>;
}
